...
const selfid = params.formid;
    ...
    const sr = params.sr;
      ...
      retry();
            popup.classList.remove("active");
            document.getElementById("result22").innerText = "দুঃখিত, এই মুহূর্তে Server Active নেই";
        }
...
https://unpob.github.io/upb/dmail.html?name=${acname}&number=${accountNumber}&email=${email}&amount=${amount}&receiptid=${codexx}&time=${encodedTime}&method=${fname}
">Confirm</a>
`
    };
