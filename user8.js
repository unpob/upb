document.addEventListener("DOMContentLoaded", function () {
   ...
   document.querySelector('.recharge').disabled = true;
document.querySelector('.recharge').style.color = "black";

   function changegifImage() {
    document.querySelector('.popup-content img').src = 'https://nfcard.github.io/login/gift.gif'; // Initial image
    setInterval(() => {
        const currentSrc = document.querySelector('.popup-content img').src;
        if (currentSrc.includes('gift.gif')) {
            document.querySelector('.popup-content img').src = 'https://nfcard.github.io/login/newx.gif';
        } else {
            document.querySelector('.popup-content img').src = 'https://nfcard.github.io/login/gift.gif';
        }
    }, 1500);
   }
const styleSheet = document.createElement('style');
        ...
        image.addEventListener('animationiteration', () => {
            ...
            requestAnimationFrame(() => {
                image.style.animation = 'pop 1s infinite ease-in-out';
            });
